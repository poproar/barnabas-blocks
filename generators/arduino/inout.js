...
Blockly.Arduino['inout_custom_digital_write'] = function(block) {
  var pin = Blockly.Arduino.valueToCode(block, 'PIN', Blockly.Arduino.ORDER_ATOMIC) || '13'
  var stat = Blockly.Arduino.valueToCode(block, 'STAT', Blockly.Arduino.ORDER_ATOMIC) || 'HIGH'
...
Blockly.Arduino['inout_digital_read'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN');
  var input_mode = block.getFieldValue('INPUT_MODE');
...
Blockly.Arduino['inout_analog_write'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN');
  var value_num = Blockly.Arduino.valueToCode(block, 'NUM', Blockly.Arduino.ORDER_ATOMIC) || '255'
...
Blockly.Arduino['pulsein'] = function(block) {
  var code;
  var value_pin = block.getFieldValue('PIN');
  var value_timeout = block.getFieldValue('TIMEOUT');
  var dropdown_type = (block.getFieldValue('type') == 'HIGH') ? 'HIGH' : 'LOW';
...
Blockly.Arduino['inout_digitalpin'] = function(block) {
...
Blockly.Arduino['inout_analogpin'] = function(block) {
